...
export class UserApi extends Construct {
    ...
    constructor(
        ...
        this.handler = new lambda.Function(this, 'UserAPILambda', {
            ...handlerConfigs.networkConfig,
            runtime: lambda.Runtime.NODEJS_18_X,
            code: lambda.Code.fromAsset('../../dist/packages/user-api'),
        ...
        this.alias = new lambda.Alias(this, 'UserAPIAlias', {
            aliasName: 'live',
        ...
        this.endpoint = new LambdaRestApi(this, 'UserAPI', {
            restApiName: `user-api-${config.stage.toString()}`,
            handler: this.alias,
