...
export class StoreApi extends Construct {
    ...
    constructor(
        ...
        this.handler = new lambda.Function(this, 'StoreAPILambda', {
            ...handlerConfigs.networkConfig,
            runtime: lambda.Runtime.NODEJS_18_X,
            code: lambda.Code.fromAsset('../../dist/packages/store-api'),
        ...
        this.alias = new lambda.Alias(this, 'StoreAPIAlias', {
            aliasName: 'live',
        ...
        this.endpoint = new LambdaRestApi(this, 'StoreAPI', {
            restApiName: `store-api-${config.stage.toString()}`,
            handler: this.alias,
